  ...
  describe('addDebugToAllFunctionsReturnStatements:', function () {
    ...
    it('should work with constructors', function() {
      ...
      var code_expected = [
        ...
        "  constructor(opts) {",
        "    this._opts = opts || {};",
        "    require('debug-print').debug({ name: 'new SomeClass()', arguments: arguments, line: {original_line: 3},",
  ...
  describe('instrumentAllFunctions:', function () {
    ...
    it('should full instrument strange functions', function() {
      ...
      var code_expected = [
        ...
        "    // TOTAL",
        "    console.log('total:', total);",
        "    require('debug-print').debug({ name: 'anonymous', arguments: arguments, line: {original_line: 3},",
        "      return_data: ('VOID') }, __filename);",
        "  }, 200);",
        "  require('debug-print').debug({ name: 'anonymous', arguments: arguments, line: {original_line: 1},",
        "    return_data: ('VOID') }, __filename);",
